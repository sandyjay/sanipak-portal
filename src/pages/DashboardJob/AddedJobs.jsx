              ...
              <div className='vstack gap-4'>
                <div className='d-flex'>
                  ...
                  <div className='ms-2 flex-grow-1'>
                    ...
                    <p className='text-muted mb-0'>
                      theclaymedia, USA - <b>53</b> sec ago
                    </p>
                  </div>
                  <UncontrolledDropdown>
                    <DropdownToggle
                ...
                <div className='d-flex'>
                  ...
                  <div className='ms-2 flex-grow-1'>
                    ...
                    <p className='text-muted mb-0'>
                      theclaymedia, Hong-Kong - <b>47</b> min ago
                    </p>
                  </div>
                  <UncontrolledDropdown>
                    <DropdownToggle
                ...
                <div className='d-flex'>
                  ...
                  <div className='ms-2 flex-grow-1'>
                    ...
                    <p className='text-muted mb-0'>
                      San-i-pak Themes, Louisiana - <b>2</b> hrs ago
                    </p>
                  </div>
                  <UncontrolledDropdown>
                    <DropdownToggle
                ...
                <div className='d-flex'>
                  ...
                  <div className='ms-2 flex-grow-1'>
                    ...
                    <p className='text-muted mb-0'>
                      San-i-pak Technology, Dominica - <b>1</b> days ago
                    </p>
                  </div>
                  <UncontrolledDropdown>
                    <DropdownToggle
                ...
                <div className='d-flex'>
                  ...
                  <div className='ms-2 flex-grow-1'>
                    ...
                    <p className='text-muted mb-0'>
                      theclaymedia, Russia - <b>2</b> days ago
                    </p>
                  </div>
                  <UncontrolledDropdown>
                    <DropdownToggle
