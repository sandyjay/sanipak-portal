...
const UiTypography = () => {
  //meta title
  document.title =
    "Typography | San-i-pak - Vite React Admin & Dashboard Template";
            ...
            <Col lg={6}>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className='card-title-desc'>
                    Use <code>text-break</code> class to prevent long strings of
                    text from breaking your components' layout.
                  </p>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className='card-title-desc'>
                    ...
                    <code>.fst-*</code> and <code>font-weight</code> utilities
                    are abbreviated as <code>.fw-*</code>.
                  </p>
