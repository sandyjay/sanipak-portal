...
const UiUtilites = () => {
  document.title =
    "Utilities | San-i-pak - Vite React Admin & Dashboard Template";
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className='card-title-desc'>
                    Use <code>.vstack</code> to create vertical layouts. Stacked
                    items are full-width by default. Use <code>.gap-*</code>{" "}
