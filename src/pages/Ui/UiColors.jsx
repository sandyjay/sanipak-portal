...
const UiColors = () => {
  //meta title
  document.title = "Colors | San-i-pak - Vite React Admin & Dashboard Template";
  return (
    <React.Fragment>
                ...
                <CardBody className='text-center'>
                  <div className='rounded overflow-hidden'>
                    <div className='color-box bg-primary p-4 rounded'>
                      <h5 className='my-2 text-white'>#4d72d0</h5>
                    </div>
            ...
            <Col xl={3} md={6}>
              <Card>
                <div className='card-body text-center'>
                  <div className='rounded overflow-hidden'>
                    <div className='p-4'>
                      <h5 className='my-2 text-primary text-opacity-75'>
                        text-opacity-75
                      </h5>
                    </div>
                    <div className='p-4'>
                      <h5 className='my-2 text-primary text-opacity-50'>
                        text-opacity-50
                      </h5>
                    </div>
                    <div className='p-4'>
                      <h5 className='my-2 text-primary text-opacity-25'>
                        text-opacity-25
                      </h5>
                    </div>
                  </div>
